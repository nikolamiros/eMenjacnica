    ...
    <>
      <div className="pt-24 pb-24">
        <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
          <div className="flex flex-col w-full mt-10 px-10 py-10 md:w-3/6 justify-center items-start text-center md:text-left">
            ...
            {/* <!-- <button
          className="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-lg my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
        >
          Subscribe
        </button> --> */}
          </div>
          <div className="w-full md:w-3/6 px-10 py-10 mt-10 text-center rounded-lg bg-white">
            <div className="space-y-2">
              <div>
                <h3 className="mb-5 text-5xl text-gray-800 font-bold leading-tight">
                  Pronađi najbolji kurs
                </h3>
              </div>
              <div className="block w-full p-3 border border-gray-700 rounded-lg bg-white mt-3">
                <select className="w-full" value="{actionName}">
                  <option value="">Odaberite akciju</option>
                  {/* Dodajte opcije za SelectAction */}
                  <option value="action1">Akcija 1</option>
                  <option value="action2">Akcija 2</option>
                </select>
              </div>

              <div className="block w-full p-3 border border-gray-700 rounded-lg bg-white mt-3 mb-3">
                <select className="w-full" value="{currency}">
                  <option value="">Odaberite valutu</option>
                  {/* Dodajte opcije za SelectCurrency */}
              ...
              <div className="flex justify-center items-center">
                <button
                  className="mx-auto w-full lg:mx-0 hover: gradient text-white text-xl font-bold rounded-lg my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
                  //onClick="{handleFindExchangeRates}"
                >
                  Pretraži
                </button>
              </div>
